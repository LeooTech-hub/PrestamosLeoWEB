...
¡Gracias por su pago!`;
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-xs animate-fadeIn">
      <div className="bg-white dark:bg-[#26221F] rounded-3xl max-w-md w-full border border-[#E6DCD2] dark:border-[#3D352E] warm-shadow-lg overflow-hidden flex flex-col max-h-[90vh] transition-colors duration-300">
        {/* Modal Header */}
        <div className="bg-gradient-to-r from-[#2C221E] to-[#3D302A] dark:from-[#1C1917] dark:to-[#26221F] text-white p-4 sm:p-5 flex items-center justify-between shrink-0">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-[#D5C8BC] dark:text-[#C2B29F]">Resumen y envío de comprobante</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        {/* Modal Body */}
        <div className="p-5 overflow-y-auto space-y-4 flex-1 text-[#2C221E] dark:text-[#EAE0D5]">
          {/* Main Receipt Card */}
          <div className="bg-[#FAF8F5] dark:bg-[#1C1917] border border-[#E6DCD2] dark:border-[#3D352E] rounded-2xl p-4 space-y-3">
            ...
            <div className="bg-white dark:bg-[#26221F] p-3 rounded-xl border border-[#E6DCD2]/70 dark:border-[#3D352E] flex items-center justify-between">
              <div>
                <span className="text-xs text-[#6E615A] dark:text-[#C2B29F] block">Abono Recibido:</span>
              ...
              <div className="text-right">
                <span className="text-xs text-[#6E615A] dark:text-[#C2B29F] block">Fecha de Pago:</span>
            ...
            <div className="grid grid-cols-2 gap-2 text-xs pt-1">
              <div>
                <span className="text-[#6E615A] dark:text-[#C2B29F] block">Detalle / Nota:</span>
                <strong className="text-[#2C221E] dark:text-[#EAE0D5] block truncate">{notes}</strong>
              </div>
              <div>
          ...
          <div className="space-y-1.5">
            ...
            <div className="bg-white dark:bg-[#1C1917] border border-[#E6DCD2] dark:border-[#3D352E] rounded-xl p-3 text-xs text-[#2C221E] dark:text-[#EAE0D5] font-mono whitespace-pre-wrap leading-relaxed max-h-36 overflow-y-auto">
              {receiptMessage}
            </div>
          </div>
        ...
        <div className="p-4 bg-[#FAF8F5] dark:bg-[#1C1917] border-t border-[#E6DCD2] dark:border-[#3D352E] flex flex-col sm:flex-row items-center justify-end gap-2 shrink-0">
          <button
            type="button"
            onClick={handleCopy}
            className="w-full sm:w-auto px-4 py-2.5 bg-white dark:bg-[#26221F] border border-[#E6DCD2] dark:border-[#3D352E] hover:bg-[#F5F0EB] dark:hover:bg-[#3D352E]/50 text-[#2C221E] dark:text-[#EAE0D5] text-xs font-bold rounded-xl transition-all flex items-center justify-center gap-2 cursor-pointer shadow-xs"
          >
            {copied ? (
              <>
